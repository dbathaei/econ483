...
\documentclass[webpdf,large,modern,namedate]{oup-authoring-template}
...
\journaltitle{ECON 483: Economic Applications of Machine Learning}
\DOI{DOI HERE}
\copyrightyear{YYYY}
\pubyear{YYYY}
...
% Add author mark
\authormark{Daniel Bathaei \and Amanda Muirhead}
